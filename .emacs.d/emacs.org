...
** Google Calendar -sykronisointi
#+BEGIN_SRC emacs-lisp

(require 'org-gcal)

(setq org-gcal-client-id google-kalenteri-client-id
      org-gcal-client-secret google-kalenteri-secret-id
      org-gcal-file-alist '((sähköpostiosoite . "/Users/tommi/Dropbox/orgfile.org")))
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'py-python-shell-mode-hook (lambda () (interactive)
					 (evil/i "C-b" 'comint-previous-input)
					 (evil/i "C-f" 'comint-next-input)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'eshell-mode-hook (lambda () (evil/i "C-f" 'eshell-next-matching-input-from-input))) 
#+END_SRC 
** Rivin manipulointi
